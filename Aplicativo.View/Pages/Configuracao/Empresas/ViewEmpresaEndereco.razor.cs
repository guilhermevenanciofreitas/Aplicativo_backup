...
{
    public class ViewEmpresaEnderecoPage : ComponentBase
    {

        public EmpresaEndereco ViewModel { get; set; } = new EmpresaEndereco();

        public ListItemViewLayout<EmpresaEndereco> ListView { get; set; }
        ...
        protected async Task ViewLayout_Carregar(object args)
        {
            ...
            ViewModel = (EmpresaEndereco)args;
        ...
        protected async Task ViewPageBtnExcluir_Click()
        {
            ...
            Excluir(new List<EmpresaEndereco>() { ViewModel });
        ...
        protected void ListViewBtnExcluir_Click(object args)
        {
            ...
            Excluir(((IEnumerable)args).Cast<EmpresaEndereco>().ToList());

        }

        public void Excluir(List<EmpresaEndereco> args)
        {
