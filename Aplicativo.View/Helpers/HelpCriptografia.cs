...
namespace Aplicativo.View.Helpers
{
    ...
    public class HelpCriptografia
    {
        ...
        /// </summary>
        private const string cryptoKey = "YLMNPtDkn1KF9rjLsFNa1fFUXSQuxnpL";
        ...
        public static string Criptografar(string text)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(text))
                {
                    ...
                    string sPassword = Convert.ToBase64String(Encoding.UTF8.GetBytes(cryptoKey));

                    // Cria instancias de vetores de bytes com as chaves                
                    byte[] bKey = Convert.FromBase64String(sPassword);
        ...
        public static string Inverter(string Value)
        {
